---
title: "Creating a world map with Gender Inequality index data (UN, 2015)"
...
### Zooming in on the Nordic-Baltic region with a few additional changes
```{r}
cols2=brewer.pal(9,"RdYlGn")
...
giiMap <- ggplot() + 
  ...
  geom_text(data=countries, aes(long,lat,label=region),size=3,color="gold1") +
  coord_equal() + 
  ylim(50,75) +
  xlim(0,35)
giiMap
